...
## Objective:
Build a slack bot using Python & its open source libraries. For example, you might choose to use the Bolt Library. Deploy this slackbot to AWS using Terraform, to AWS lambda with an API gateway.
...
## Acceptance Criteria:
A slackbot that responds to a slash command or some other event. Deployed to AWS using Terraform.
